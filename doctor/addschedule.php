...
//INSERT
$query = " INSERT INTO doctorschedule ( doctorId, scheduleDate, startTime,  endTime, scheduleDay, bookAvail )
VALUES ( '$usersession', '$date', '$starttime', '$endtime', '$scheduleday', '$bookavail' ) ";
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <!-- panel heading starat -->
                        <div class="panel-heading">
                            <h3 class="panel-title">Your Schedules</h3>
