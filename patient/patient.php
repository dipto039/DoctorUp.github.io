...
$user=mysqli_query($con,"SELECT patientFirstName FROM patient WHERE icPatient=".$usersession);
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<ul class="nav navbar-nav">
							...
							<li><a href="patientapplist.php?patientId=<?php echo $usersession; ?>">Appointment</a></li>
							<li><a href="review.php?patientId=<?php echo $usersession; ?>">Review</a></li>
						</ul>
					</ul>
					
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $user['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?><b class="caret"></b></a>
