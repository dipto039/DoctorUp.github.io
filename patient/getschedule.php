        ...
        echo "   <table class='table table-hover'>";
            ...
            echo "  <tbody>";
                ...
                <tr>
                    ...
                    $p=$row['doctorId'];
                    $doc = mysqli_query($con,"SELECT * FROM doctor WHERE doctorId= '$p'");
                    $doc = mysqli_fetch_array($doc);
                    
                    echo "<td>" . "Dr. ". $doc['doctorFirstName']." ".$doc['doctorLastName'] . "</td>";
                    echo "<td>" . $doc['speciality'] . "</td>";
