...
$user=mysqli_query($con,"SELECT * FROM patient WHERE icPatient=".$session);
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $user['patientFirstName']; ?> <?php echo $user['patientLastName']; ?><b class="caret"></b></a>
