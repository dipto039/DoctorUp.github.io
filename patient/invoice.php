    ...
    <body>
                ...
                <tr class="top">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td class="title">
                                    <img src="assets/img/docup_logo.svg" style="width:100%; max-width:300px;">
                                </td>
                ...
                <tr class="information">
                    <td colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <?php echo $userRow['doctorFirstName'];?> <?php echo $userRow['doctorLastName'];?><br>
                                    <?php echo $userRow['doctorPhone'];?><br>
                                    <?php echo $userRow['doctorEmail'];?><br>
                                    <?php echo $userRow['doctorAddress'];?><br>
                                </td>
                                
                                <td>
                                    <?php echo $userRow['patientIc'];?><br>
                                    <?php echo $userRow['patientFirstName'];?> <?php echo $userRow['patientLastName'];?><br>
                                    <?php echo "0".$userRow['patientPhone'];?><br>
        ...
        <div class="print">
            ...
            <div class='col-md-offset-3 pull-right'>
                <button type="button" class="btn btn-primary" align= "center" onclick="myFunction()">Print this page</button>
            </div>
        </div>
<script>
function myFunction() {
